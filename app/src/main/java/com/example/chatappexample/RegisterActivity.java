...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void register(final String username, String email, String password){
        Toast.makeText(RegisterActivity.this, "fun", Toast.LENGTH_SHORT).show();
...
reference = FirebaseDatabase.getInstance().getReference("Users").child(firebaseUser.getUid().toString());
